# -*- encoding: utf-8 -*-
'''
file       : OllamaManager.py
Description: Integration with Ollama for local LLM inference
Date       : 2024/05/15
...
class OllamaManager:
    ...
    def generate_response(self, prompt, model="llama2", base_url="http://localhost:11434", temperature=0.7, max_tokens=2048):
        """
    ...
    def generate_sequences(self, model="llama2", base_url="http://localhost:11434", 
